...
Чтобы выделить текст как цитата, необходимо перед ним постоавить закрывающуюся угловую скобку (>). Чтобы последующий текст не попал под выделение циататы, его необходимо отделить одной пустой строчкой. Так же в цитате можно совмещать, написание текста курсивом и полужирным.

Пример:  
\>Цитата \*курсив* \*\*полужирный**
